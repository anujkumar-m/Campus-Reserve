...
const roleColors = {
  infra_admin: 'bg-destructive/10 text-destructive',
  it_admin: 'bg-destructive/10 text-destructive',
...
export default function UsersPage() {
  ...
  const { data: users = [], isLoading } = useQuery({
    ...
    enabled: currentUser?.role === 'infra_admin' || currentUser?.role === 'it_admin',
  });
  ...
  const usersByRole = {
    infra_admin: users.filter((u: any) => u.role === 'infra_admin'),
    it_admin: users.filter((u: any) => u.role === 'it_admin'),
  ...
  if (currentUser?.role !== 'infra_admin' && currentUser?.role !== 'it_admin') {
    return (
                ...
                <div className="grid gap-2">
                  ...
                  <Select value={role} onValueChange={setRole}>
                    ...
                    <SelectContent>
                      ...
                      <SelectItem value="infra_admin">Infrastructure Admin</SelectItem>
